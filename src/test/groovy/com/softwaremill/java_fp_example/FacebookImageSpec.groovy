...
class FacebookImageSpec extends Specification {
    ...
    def "should test Initial Version with address #postAddress"() {
        given:
        FacebookImageInitialVersion facebookImage = new FacebookImageInitialVersion()
    ...
    @Unroll
    def "should test more objective version with address #postAddress"() {
        when:
        FacebookImageMoreObjective facebookImage = new FacebookImageMoreObjective(postAddress)
    ...
    def "should test Javaslang Version One with address #postAddress"() {
        given:
        FacebookImageJavaslangVersionOne facebookImage = new FacebookImageJavaslangVersionOne()
    ...
    def "should test Javaslang Version Two with address #postAddress"() {
        given:
        FacebookImageJavaslangVersionTwo facebookImage = new FacebookImageJavaslangVersionTwo()
    ...
    def "should test Pure Java8 with Lambdista Try with address #postAddress"() {
        given:
        FacebookImagePureJava8AndLambdistaTry facebookImage = new FacebookImagePureJava8AndLambdistaTry()
